    ...
    return (
        <AuthenticatedLayout>
            <div className="relative">                   
                <div className="p-6 sticky top-0 shadow-xl bg-white z-0 flex text-blue-700">
                ...
                {showBoard && (
                    <div className='fixed h-screen inset-0 z-10 flex'>
                        <div className='p-6 w-2/3 h-full bg-blue-600 opacity-95 text-white shadow-xl'>
                            ...
                            <nav className="flex flex-col gap-3">
                                <a onClick={()=>{setShowDashboardContains('mesprojets'); setShowBoard(false)}} className='bg-blue-700 flex flex-row gap-2 text-left p-3 w-full rounded hover:bg-blue-800 transition'>
                                    <FaBriefcase className='mt-1'></FaBriefcase>
                                    Mes projets
                                </a>
                                <a href={route('touslesprojets')} className='bg-blue-700 flex flex-row gap-2 text-left p-3 w-full rounded hover:bg-blue-800 transition'>
                                ...
                                <a onClick={()=>{setShowDashboardContains('gantt'); setShowBoard(false)}} className='bg-blue-700 flex flex-row gap-2 text-left p-3 w-full rounded hover:bg-blue-800 transition'>
                                    <FaProjectDiagram className='mt-1'/>
                                    Gantt
                                </a>
                                <a onClick={()=>{setShowDashboardContains('rapports'); setShowBoard(false)}} className='bg-blue-700 flex flex-row gap-2 text-left p-3 w-full rounded hover:bg-blue-800 transition'>
                                    <FaFileAlt className='mt-1'></FaFileAlt>
                                    Rapports
                                </a>
                                <a onClick={()=>{setShowDashboardContains('données'); setShowBoard(false)}} className='bg-blue-700 flex flex-row gap-2 text-left p-3 w-full rounded hover:bg-blue-800 transition'>
